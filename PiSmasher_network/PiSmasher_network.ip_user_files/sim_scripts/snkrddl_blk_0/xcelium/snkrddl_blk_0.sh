...
#
# Script generated by Vivado on Fri Apr 26 22:41:24 PDT 2024
# SW Build 4126759 on Thu Feb  8 23:52:05 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : snkrddl_blk_0.sh
...
#
# Usage        : snkrddl_blk_0.sh
#                snkrddl_blk_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                snkrddl_blk_0.sh [-reset_run]
#                snkrddl_blk_0.sh [-reset_log]
#                snkrddl_blk_0.sh [-help]
#
...
#                script (type 'snkrddl_blk_0.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_16 -libname processing_system7_vip_v1_0_18 -libname xil_defaultlib -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_14 -libname gmii_to_rgmii_v4_1_13 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_16 processing_system7_vip_v1_0_18 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_14 gmii_to_rgmii_v4_1_13)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "snkrddl_blk_0.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./snkrddl_blk_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/ec67/hdl" +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/570d/hdl" +incdir+"/home/tasker/Programs/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/ec67/hdl" +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/570d/hdl" +incdir+"/home/tasker/Programs/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_vip_v1_1_16 $xmvlog_opts -sv +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/ec67/hdl" +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/570d/hdl" +incdir+"/home/tasker/Programs/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/fd36/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_18 $xmvlog_opts -sv +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/ec67/hdl" +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/570d/hdl" +incdir+"/home/tasker/Programs/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/570d/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/ec67/hdl" +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/570d/hdl" +incdir+"/home/tasker/Programs/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvhdl -work gmii_to_rgmii_v4_1_13 -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.snkrddl_blk_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.snkrddl_blk_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tasker/Projects/Vivado_workspace/PiSmasher_network/PiSmasher_network.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log snkrddl_blk_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./snkrddl_blk_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: snkrddl_blk_0.sh [-help]\n\
Usage: snkrddl_blk_0.sh [-step]\n\
Usage: snkrddl_blk_0.sh [-lib_map_path]\n\
Usage: snkrddl_blk_0.sh [-reset_run]\n\
Usage: snkrddl_blk_0.sh [-reset_log]\n\
Usage: snkrddl_blk_0.sh [-keep_index]\n\
Usage: snkrddl_blk_0.sh [-noclean_files]\n\n\
