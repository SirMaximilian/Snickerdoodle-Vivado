...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_16 -L processing_system7_vip_v1_0_18 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_14 -L gmii_to_rgmii_v4_1_13 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot snkrddl_blk_0 xil_defaultlib.snkrddl_blk_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim snkrddl_blk_0 -key {Behavioral:sim_1:Functional:snkrddl_blk_0} -tclbatch cmd.tcl -protoinst "protoinst_files/snkrddl_blk_0.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tasker/Programs/Xilinx/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb snkrddl_blk_0.wdb xsim.dir libdpi.so)
