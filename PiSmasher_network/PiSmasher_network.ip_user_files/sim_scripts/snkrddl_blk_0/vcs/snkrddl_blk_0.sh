...
design_libs=(xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_16 processing_system7_vip_v1_0_18 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_14 gmii_to_rgmii_v4_1_13)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/ec67/hdl" +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/570d/hdl" +incdir+"/home/tasker/Programs/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/ec67/hdl" +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/570d/hdl" +incdir+"/home/tasker/Programs/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_vip_v1_1_16 $vlogan_opts -sverilog +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/ec67/hdl" +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/570d/hdl" +incdir+"/home/tasker/Programs/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/fd36/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_18 $vlogan_opts -sverilog +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/ec67/hdl" +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/570d/hdl" +incdir+"/home/tasker/Programs/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/570d/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/ec67/hdl" +incdir+"../../../../PiSmasher_network.gen/sources_1/bd/snkrddl_blk_0/ipshared/570d/hdl" +incdir+"/home/tasker/Programs/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vhdlan -work gmii_to_rgmii_v4_1_13 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.snkrddl_blk_0 xil_defaultlib.glbl -o snkrddl_blk_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./snkrddl_blk_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tasker/Projects/Vivado_workspace/PiSmasher_network/PiSmasher_network.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key snkrddl_blk_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc snkrddl_blk_0_simv.daidir vcs_lib c.obj)
